...
export function TopBar() {
  return (
    <header className="md:hidden flex items-center justify-between h-14 px-4 bg-white border-b border-cyan-100 shadow-sm sticky top-0 z-50">
      ...
      <Sheet>
        ...
        <SheetContent side="left" className="p-0 w-64 border-r-cyan-200">
